...
export const ExerciseCard = ({
  ...
  return (
    <div className="flex flex-col flex-1 w-full">
      ...
      {/* Progress indicator — just below header */}
      ...
      <div className="flex-1 flex flex-col items-center justify-center">
        <p className="text-slate-400 text-sm mb-4">Tap to enter morse</p>
      ...
      {/* Overlay feedback banner — no layout shift */}
      {feedback && (
        <div
          className={`fixed inset-x-0 top-16 z-50 mx-4 rounded-xl py-3 px-4 text-center shadow-lg ${
            feedback === 'correct'
            ...
            <div>
              ...
              {showAnswer && (
                <p className="text-sm mt-1 opacity-90">
                  {exercise.letter} = {exercise.morse}
                </p>
              )}
            </div>
          )}
